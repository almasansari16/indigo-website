      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-5 xl:mr-12">
              <Link
                href="/"
              ...
              >
                <Image
                  ...
                  alt="logo"
                  width={120} // Change to desired width
                  height={120} // Change to desired height
                    ...
                    {menuData.map((menuItem, index) => (
                      <li key={index} className="group relative">
                        {menuItem.path ? (
                          <Link
                            href={menuItem.path}
                            className={` raleway flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${usePathName === menuItem.path
